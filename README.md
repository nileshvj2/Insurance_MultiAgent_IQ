...
git clone https://github.com/nileshvj2/Insurance_MultiAgent_IQ.git
cd Insurance_MultiAgent_IQ
...
- **WorkIQ**: No additional set up is required (Pre-req - M365 Copilot license to use WorkIQ features)
